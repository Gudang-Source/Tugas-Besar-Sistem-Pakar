                ...
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            ...
                            @endif
                            <div class="header">
                                <div class="logo text-center"><img src="{{ asset('assets/user/img/logo-dark.png') }}" alt="Klorofil Logo">
                                </div>
                            ...
                            <form class="form-auth-small" action="{{ url('/postlogin') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="signin-email"
                                        value="admin@p.com" placeholder="Email" name="email">
                                </div>
                                <div class="form-group">
                                    <label for="signin-password" class="control-label sr-only">Password</label>
                                    <input type="password" class="form-control" id="signin-password"
                                        value="adminkece" placeholder="Password" name="password">
                                </div>
